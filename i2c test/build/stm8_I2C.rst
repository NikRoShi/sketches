      ...
      00827B 72 12 52 11      [ 1]   80 	bset	0x5211, #1
      ...
      0082ED 81               [ 4]  184 	ret
                                    ...
                                    188 ;	-----------------------------------------
      0082EE                        189 _ping_I2C:
      0082EE 88               [ 1]  190 	push	a
      0082EF 6B 01            [ 1]  191 	ld	(0x01, sp), a
                                    192 ;	../../my_STM8_libraries/stm8_I2C.c: 93: if (start_I2C() == 0) return 0;
      0082F1 CD 82 80         [ 4]  193 	call	_start_I2C
      0082F4 4D               [ 1]  194 	tnz	a
      0082F5 26 03            [ 1]  195 	jrne	00102$
      0082F7 4F               [ 1]  196 	clr	a
      0082F8 20 10            [ 2]  197 	jra	00105$
      0082FA                        198 00102$:
                                    199 ;	../../my_STM8_libraries/stm8_I2C.c: 94: if (writeAddr_I2C(address) == 0) return 0; 
      0082FA 7B 01            [ 1]  200 	ld	a, (0x01, sp)
      0082FC CD 82 98         [ 4]  201 	call	_writeAddr_I2C
      0082FF 4D               [ 1]  202 	tnz	a
      008300 26 03            [ 1]  203 	jrne	00104$
      008302 4F               [ 1]  204 	clr	a
      008303 20 05            [ 2]  205 	jra	00105$
      008305                        206 00104$:
                                    207 ;	../../my_STM8_libraries/stm8_I2C.c: 95: stop_I2C();
      008305 CD 82 7B         [ 4]  208 	call	_stop_I2C
                                    209 ;	../../my_STM8_libraries/stm8_I2C.c: 96: return 1;
      008308 A6 01            [ 1]  210 	ld	a, #0x01
      00830A                        211 00105$:
                                    212 ;	../../my_STM8_libraries/stm8_I2C.c: 97: }
      00830A 5B 01            [ 2]  213 	addw	sp, #1
      00830C 81               [ 4]  214 	ret
                                    215 ;	../../my_STM8_libraries/stm8_I2C.c: 99: uint8_t writeReg(uint8_t address, uint8_t reg, uint8_t data)
                                    216 ;	-----------------------------------------
                                    217 ;	 function writeReg
                                    218 ;	-----------------------------------------
      00830D                        219 _writeReg:
      00830D 88               [ 1]  220 	push	a
      00830E 6B 01            [ 1]  221 	ld	(0x01, sp), a
                                    222 ;	../../my_STM8_libraries/stm8_I2C.c: 101: if (start_I2C() == 0) return 0;
      008310 CD 82 80         [ 4]  223 	call	_start_I2C
      008313 4D               [ 1]  224 	tnz	a
      008314 26 03            [ 1]  225 	jrne	00102$
      008316 4F               [ 1]  226 	clr	a
      008317 20 26            [ 2]  227 	jra	00109$
      008319                        228 00102$:
                                    229 ;	../../my_STM8_libraries/stm8_I2C.c: 102: if (writeAddr_I2C(address) == 0) return 0;
      008319 7B 01            [ 1]  230 	ld	a, (0x01, sp)
      00831B CD 82 98         [ 4]  231 	call	_writeAddr_I2C
      00831E 4D               [ 1]  232 	tnz	a
      00831F 26 03            [ 1]  233 	jrne	00104$
      008321 4F               [ 1]  234 	clr	a
      008322 20 1B            [ 2]  235 	jra	00109$
      008324                        236 00104$:
                                    237 ;	../../my_STM8_libraries/stm8_I2C.c: 103: if (writeByte_I2C(reg) == 0) return 0;
      008324 7B 04            [ 1]  238 	ld	a, (0x04, sp)
      008326 CD 82 C9         [ 4]  239 	call	_writeByte_I2C
      008329 4D               [ 1]  240 	tnz	a
      00832A 26 03            [ 1]  241 	jrne	00106$
      00832C 4F               [ 1]  242 	clr	a
      00832D 20 10            [ 2]  243 	jra	00109$
      00832F                        244 00106$:
                                    245 ;	../../my_STM8_libraries/stm8_I2C.c: 104: if (writeByte_I2C(data) == 0) return 0;
      00832F 7B 05            [ 1]  246 	ld	a, (0x05, sp)
      008331 CD 82 C9         [ 4]  247 	call	_writeByte_I2C
      008334 4D               [ 1]  248 	tnz	a
      008335 26 03            [ 1]  249 	jrne	00108$
      008337 4F               [ 1]  250 	clr	a
      008338 20 05            [ 2]  251 	jra	00109$
      00833A                        252 00108$:
                                    253 ;	../../my_STM8_libraries/stm8_I2C.c: 105: stop_I2C();
      00833A CD 82 7B         [ 4]  254 	call	_stop_I2C
                                    255 ;	../../my_STM8_libraries/stm8_I2C.c: 106: return 1;
      00833D A6 01            [ 1]  256 	ld	a, #0x01
      00833F                        257 00109$:
                                    258 ;	../../my_STM8_libraries/stm8_I2C.c: 107: }
      00833F 1E 02            [ 2]  259 	ldw	x, (2, sp)
      008341 5B 05            [ 2]  260 	addw	sp, #5
      008343 FC               [ 2]  261 	jp	(x)
                                    262 	.area CODE
                                    263 	.area CONST
