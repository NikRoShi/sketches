      ...
      008254 72 12 52 11      [ 1]   80 	bset	0x5211, #1
      ...
      0082C6 81               [ 4]  184 	ret
                                    ...
                                    188 ;	-----------------------------------------
      0082C7                        189 _ping_I2C:
      0082C7 88               [ 1]  190 	push	a
      0082C8 6B 01            [ 1]  191 	ld	(0x01, sp), a
                                    192 ;	../../my_STM8_libraries/stm8_I2C.c: 93: if (start_I2C() == 0) return 0;
      0082CA CD 82 59         [ 4]  193 	call	_start_I2C
      0082CD 4D               [ 1]  194 	tnz	a
      0082CE 26 03            [ 1]  195 	jrne	00102$
      0082D0 4F               [ 1]  196 	clr	a
      0082D1 20 10            [ 2]  197 	jra	00105$
      0082D3                        198 00102$:
                                    199 ;	../../my_STM8_libraries/stm8_I2C.c: 94: if (writeAddr_I2C(address) == 0) return 0; 
      0082D3 7B 01            [ 1]  200 	ld	a, (0x01, sp)
      0082D5 CD 82 71         [ 4]  201 	call	_writeAddr_I2C
      0082D8 4D               [ 1]  202 	tnz	a
      0082D9 26 03            [ 1]  203 	jrne	00104$
      0082DB 4F               [ 1]  204 	clr	a
      0082DC 20 05            [ 2]  205 	jra	00105$
      0082DE                        206 00104$:
                                    207 ;	../../my_STM8_libraries/stm8_I2C.c: 95: stop_I2C();
      0082DE CD 82 54         [ 4]  208 	call	_stop_I2C
                                    209 ;	../../my_STM8_libraries/stm8_I2C.c: 96: return 1;
      0082E1 A6 01            [ 1]  210 	ld	a, #0x01
      0082E3                        211 00105$:
                                    212 ;	../../my_STM8_libraries/stm8_I2C.c: 97: }
      0082E3 5B 01            [ 2]  213 	addw	sp, #1
      0082E5 81               [ 4]  214 	ret
                                    215 ;	../../my_STM8_libraries/stm8_I2C.c: 99: uint8_t writeReg(uint8_t address, uint8_t reg, uint8_t data)
                                    216 ;	-----------------------------------------
                                    217 ;	 function writeReg
                                    218 ;	-----------------------------------------
      0082E6                        219 _writeReg:
      0082E6 88               [ 1]  220 	push	a
      0082E7 6B 01            [ 1]  221 	ld	(0x01, sp), a
                                    222 ;	../../my_STM8_libraries/stm8_I2C.c: 101: if (start_I2C() == 0) return 0;
      0082E9 CD 82 59         [ 4]  223 	call	_start_I2C
      0082EC 4D               [ 1]  224 	tnz	a
      0082ED 26 03            [ 1]  225 	jrne	00102$
      0082EF 4F               [ 1]  226 	clr	a
      0082F0 20 26            [ 2]  227 	jra	00109$
      0082F2                        228 00102$:
                                    229 ;	../../my_STM8_libraries/stm8_I2C.c: 102: if (writeAddr_I2C(address) == 0) return 0;
      0082F2 7B 01            [ 1]  230 	ld	a, (0x01, sp)
      0082F4 CD 82 71         [ 4]  231 	call	_writeAddr_I2C
      0082F7 4D               [ 1]  232 	tnz	a
      0082F8 26 03            [ 1]  233 	jrne	00104$
      0082FA 4F               [ 1]  234 	clr	a
      0082FB 20 1B            [ 2]  235 	jra	00109$
      0082FD                        236 00104$:
                                    237 ;	../../my_STM8_libraries/stm8_I2C.c: 103: if (writeByte_I2C(reg) == 0) return 0;
      0082FD 7B 04            [ 1]  238 	ld	a, (0x04, sp)
      0082FF CD 82 A2         [ 4]  239 	call	_writeByte_I2C
      008302 4D               [ 1]  240 	tnz	a
      008303 26 03            [ 1]  241 	jrne	00106$
      008305 4F               [ 1]  242 	clr	a
      008306 20 10            [ 2]  243 	jra	00109$
      008308                        244 00106$:
                                    245 ;	../../my_STM8_libraries/stm8_I2C.c: 104: if (writeByte_I2C(data) == 0) return 0;
      008308 7B 05            [ 1]  246 	ld	a, (0x05, sp)
      00830A CD 82 A2         [ 4]  247 	call	_writeByte_I2C
      00830D 4D               [ 1]  248 	tnz	a
      00830E 26 03            [ 1]  249 	jrne	00108$
      008310 4F               [ 1]  250 	clr	a
      008311 20 05            [ 2]  251 	jra	00109$
      008313                        252 00108$:
                                    253 ;	../../my_STM8_libraries/stm8_I2C.c: 105: stop_I2C();
      008313 CD 82 54         [ 4]  254 	call	_stop_I2C
                                    255 ;	../../my_STM8_libraries/stm8_I2C.c: 106: return 1;
      008316 A6 01            [ 1]  256 	ld	a, #0x01
      008318                        257 00109$:
                                    258 ;	../../my_STM8_libraries/stm8_I2C.c: 107: }
      008318 1E 02            [ 2]  259 	ldw	x, (2, sp)
      00831A 5B 05            [ 2]  260 	addw	sp, #5
      00831C FC               [ 2]  261 	jp	(x)
                                    262 	.area CODE
                                    263 	.area CONST
