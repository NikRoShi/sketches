      ...
      008256 72 12 52 11      [ 1]   80 	bset	0x5211, #1
      ...
      0082C8 81               [ 4]  184 	ret
                                    ...
                                    188 ;	-----------------------------------------
      0082C9                        189 _ping_I2C:
      0082C9 88               [ 1]  190 	push	a
      0082CA 6B 01            [ 1]  191 	ld	(0x01, sp), a
                                    192 ;	../../my_STM8_libraries/stm8_I2C.c: 93: if (start_I2C() == 0) return 0;
      0082CC CD 82 5B         [ 4]  193 	call	_start_I2C
      0082CF 4D               [ 1]  194 	tnz	a
      0082D0 26 03            [ 1]  195 	jrne	00102$
      0082D2 4F               [ 1]  196 	clr	a
      0082D3 20 10            [ 2]  197 	jra	00105$
      0082D5                        198 00102$:
                                    199 ;	../../my_STM8_libraries/stm8_I2C.c: 94: if (writeAddr_I2C(address) == 0) return 0; 
      0082D5 7B 01            [ 1]  200 	ld	a, (0x01, sp)
      0082D7 CD 82 73         [ 4]  201 	call	_writeAddr_I2C
      0082DA 4D               [ 1]  202 	tnz	a
      0082DB 26 03            [ 1]  203 	jrne	00104$
      0082DD 4F               [ 1]  204 	clr	a
      0082DE 20 05            [ 2]  205 	jra	00105$
      0082E0                        206 00104$:
                                    207 ;	../../my_STM8_libraries/stm8_I2C.c: 95: stop_I2C();
      0082E0 CD 82 56         [ 4]  208 	call	_stop_I2C
                                    209 ;	../../my_STM8_libraries/stm8_I2C.c: 96: return 1;
      0082E3 A6 01            [ 1]  210 	ld	a, #0x01
      0082E5                        211 00105$:
                                    212 ;	../../my_STM8_libraries/stm8_I2C.c: 97: }
      0082E5 5B 01            [ 2]  213 	addw	sp, #1
      0082E7 81               [ 4]  214 	ret
                                    215 ;	../../my_STM8_libraries/stm8_I2C.c: 99: uint8_t writeReg(uint8_t address, uint8_t reg, uint8_t data)
                                    216 ;	-----------------------------------------
                                    217 ;	 function writeReg
                                    218 ;	-----------------------------------------
      0082E8                        219 _writeReg:
      0082E8 88               [ 1]  220 	push	a
      0082E9 6B 01            [ 1]  221 	ld	(0x01, sp), a
                                    222 ;	../../my_STM8_libraries/stm8_I2C.c: 101: if (start_I2C() == 0) return 0;
      0082EB CD 82 5B         [ 4]  223 	call	_start_I2C
      0082EE 4D               [ 1]  224 	tnz	a
      0082EF 26 03            [ 1]  225 	jrne	00102$
      0082F1 4F               [ 1]  226 	clr	a
      0082F2 20 26            [ 2]  227 	jra	00109$
      0082F4                        228 00102$:
                                    229 ;	../../my_STM8_libraries/stm8_I2C.c: 102: if (writeAddr_I2C(address) == 0) return 0;
      0082F4 7B 01            [ 1]  230 	ld	a, (0x01, sp)
      0082F6 CD 82 73         [ 4]  231 	call	_writeAddr_I2C
      0082F9 4D               [ 1]  232 	tnz	a
      0082FA 26 03            [ 1]  233 	jrne	00104$
      0082FC 4F               [ 1]  234 	clr	a
      0082FD 20 1B            [ 2]  235 	jra	00109$
      0082FF                        236 00104$:
                                    237 ;	../../my_STM8_libraries/stm8_I2C.c: 103: if (writeByte_I2C(reg) == 0) return 0;
      0082FF 7B 04            [ 1]  238 	ld	a, (0x04, sp)
      008301 CD 82 A4         [ 4]  239 	call	_writeByte_I2C
      008304 4D               [ 1]  240 	tnz	a
      008305 26 03            [ 1]  241 	jrne	00106$
      008307 4F               [ 1]  242 	clr	a
      008308 20 10            [ 2]  243 	jra	00109$
      00830A                        244 00106$:
                                    245 ;	../../my_STM8_libraries/stm8_I2C.c: 104: if (writeByte_I2C(data) == 0) return 0;
      00830A 7B 05            [ 1]  246 	ld	a, (0x05, sp)
      00830C CD 82 A4         [ 4]  247 	call	_writeByte_I2C
      00830F 4D               [ 1]  248 	tnz	a
      008310 26 03            [ 1]  249 	jrne	00108$
      008312 4F               [ 1]  250 	clr	a
      008313 20 05            [ 2]  251 	jra	00109$
      008315                        252 00108$:
                                    253 ;	../../my_STM8_libraries/stm8_I2C.c: 105: stop_I2C();
      008315 CD 82 56         [ 4]  254 	call	_stop_I2C
                                    255 ;	../../my_STM8_libraries/stm8_I2C.c: 106: return 1;
      008318 A6 01            [ 1]  256 	ld	a, #0x01
      00831A                        257 00109$:
                                    258 ;	../../my_STM8_libraries/stm8_I2C.c: 107: }
      00831A 1E 02            [ 2]  259 	ldw	x, (2, sp)
      00831C 5B 05            [ 2]  260 	addw	sp, #5
      00831E FC               [ 2]  261 	jp	(x)
                                    262 	.area CODE
                                    263 	.area CONST
