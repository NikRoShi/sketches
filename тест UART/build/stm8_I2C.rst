      ...
      0082EE 72 12 52 11      [ 1]   81 	bset	0x5211, #1
      ...
      008375 81               [ 4]  200 	ret
                                    ...
                                    204 ;	-----------------------------------------
      008376                        205 _ping_I2C:
      008376 88               [ 1]  206 	push	a
      008377 6B 01            [ 1]  207 	ld	(0x01, sp), a
                                    208 ;	../../my_STM8_libraries/stm8_I2C.c: 95: if (start_I2C() == 0) return 0;
      008379 CD 82 F3         [ 4]  209 	call	_start_I2C
      00837C 4D               [ 1]  210 	tnz	a
      00837D 26 03            [ 1]  211 	jrne	00102$
      00837F 4F               [ 1]  212 	clr	a
      008380 20 12            [ 2]  213 	jra	00105$
      008382                        214 00102$:
                                    215 ;	../../my_STM8_libraries/stm8_I2C.c: 96: if (writeAddr_I2C(address, WRITE) == 0) return 0; 
      008382 4B 00            [ 1]  216 	push	#0x00
      008384 7B 02            [ 1]  217 	ld	a, (0x02, sp)
      008386 CD 83 0B         [ 4]  218 	call	_writeAddr_I2C
      008389 4D               [ 1]  219 	tnz	a
      00838A 26 03            [ 1]  220 	jrne	00104$
      00838C 4F               [ 1]  221 	clr	a
      00838D 20 05            [ 2]  222 	jra	00105$
      00838F                        223 00104$:
                                    224 ;	../../my_STM8_libraries/stm8_I2C.c: 97: stop_I2C();
      00838F CD 82 EE         [ 4]  225 	call	_stop_I2C
                                    226 ;	../../my_STM8_libraries/stm8_I2C.c: 98: return 1;
      008392 A6 01            [ 1]  227 	ld	a, #0x01
      008394                        228 00105$:
                                    229 ;	../../my_STM8_libraries/stm8_I2C.c: 99: }
      008394 5B 01            [ 2]  230 	addw	sp, #1
      008396 81               [ 4]  231 	ret
                                    ...
                                    235 ;	-----------------------------------------
      008397                        236 _writeReg_I2C:
      008397 88               [ 1]  237 	push	a
      008398 6B 01            [ 1]  238 	ld	(0x01, sp), a
                                    239 ;	../../my_STM8_libraries/stm8_I2C.c: 103: if (start_I2C() == 0) return 0;
      00839A CD 82 F3         [ 4]  240 	call	_start_I2C
      00839D 4D               [ 1]  241 	tnz	a
      00839E 26 03            [ 1]  242 	jrne	00102$
      0083A0 4F               [ 1]  243 	clr	a
      0083A1 20 28            [ 2]  244 	jra	00109$
      0083A3                        245 00102$:
                                    246 ;	../../my_STM8_libraries/stm8_I2C.c: 104: if (writeAddr_I2C(address, WRITE) == 0) return 0;
      0083A3 4B 00            [ 1]  247 	push	#0x00
      0083A5 7B 02            [ 1]  248 	ld	a, (0x02, sp)
      0083A7 CD 83 0B         [ 4]  249 	call	_writeAddr_I2C
      0083AA 4D               [ 1]  250 	tnz	a
      0083AB 26 03            [ 1]  251 	jrne	00104$
      0083AD 4F               [ 1]  252 	clr	a
      0083AE 20 1B            [ 2]  253 	jra	00109$
      0083B0                        254 00104$:
                                    255 ;	../../my_STM8_libraries/stm8_I2C.c: 105: if (writeByte_I2C(reg) == 0) return 0;
      0083B0 7B 04            [ 1]  256 	ld	a, (0x04, sp)
      0083B2 CD 83 51         [ 4]  257 	call	_writeByte_I2C
      0083B5 4D               [ 1]  258 	tnz	a
      0083B6 26 03            [ 1]  259 	jrne	00106$
      0083B8 4F               [ 1]  260 	clr	a
      0083B9 20 10            [ 2]  261 	jra	00109$
      0083BB                        262 00106$:
                                    263 ;	../../my_STM8_libraries/stm8_I2C.c: 106: if (writeByte_I2C(data) == 0) return 0;
      0083BB 7B 05            [ 1]  264 	ld	a, (0x05, sp)
      0083BD CD 83 51         [ 4]  265 	call	_writeByte_I2C
      0083C0 4D               [ 1]  266 	tnz	a
      0083C1 26 03            [ 1]  267 	jrne	00108$
      0083C3 4F               [ 1]  268 	clr	a
      0083C4 20 05            [ 2]  269 	jra	00109$
      0083C6                        270 00108$:
                                    271 ;	../../my_STM8_libraries/stm8_I2C.c: 107: stop_I2C();
      0083C6 CD 82 EE         [ 4]  272 	call	_stop_I2C
                                    273 ;	../../my_STM8_libraries/stm8_I2C.c: 108: return 1;
      0083C9 A6 01            [ 1]  274 	ld	a, #0x01
      0083CB                        275 00109$:
                                    276 ;	../../my_STM8_libraries/stm8_I2C.c: 109: }
      0083CB 1E 02            [ 2]  277 	ldw	x, (2, sp)
      0083CD 5B 05            [ 2]  278 	addw	sp, #5
      0083CF FC               [ 2]  279 	jp	(x)
                                    280 ;	../../my_STM8_libraries/stm8_I2C.c: 111: uint8_t readByte_I2C(uint8_t address, uint8_t *data)
                                    281 ;	-----------------------------------------
                                    282 ;	 function readByte_I2C
                                    283 ;	-----------------------------------------
      0083D0                        284 _readByte_I2C:
      0083D0 52 03            [ 2]  285 	sub	sp, #3
      0083D2 6B 03            [ 1]  286 	ld	(0x03, sp), a
      0083D4 1F 01            [ 2]  287 	ldw	(0x01, sp), x
                                    288 ;	../../my_STM8_libraries/stm8_I2C.c: 115: if (start_I2C() == 0) return 0;
      0083D6 CD 82 F3         [ 4]  289 	call	_start_I2C
      0083D9 4D               [ 1]  290 	tnz	a
      0083DA 26 03            [ 1]  291 	jrne	00102$
      0083DC 4F               [ 1]  292 	clr	a
      0083DD 20 32            [ 2]  293 	jra	00110$
      0083DF                        294 00102$:
                                    295 ;	../../my_STM8_libraries/stm8_I2C.c: 117: I2C_CR2 &= ~I2C_CR2_ACK;
      0083DF 72 15 52 11      [ 1]  296 	bres	0x5211, #2
                                    297 ;	../../my_STM8_libraries/stm8_I2C.c: 119: if (writeAddr_I2C(address, READ) == 0) return 0;
      0083E3 4B 01            [ 1]  298 	push	#0x01
      0083E5 7B 04            [ 1]  299 	ld	a, (0x04, sp)
      0083E7 CD 83 0B         [ 4]  300 	call	_writeAddr_I2C
      0083EA 4D               [ 1]  301 	tnz	a
      0083EB 26 03            [ 1]  302 	jrne	00115$
      0083ED 4F               [ 1]  303 	clr	a
      0083EE 20 21            [ 2]  304 	jra	00110$
                                    305 ;	../../my_STM8_libraries/stm8_I2C.c: 121: while (!(I2C_SR1 & I2C_SR1_RXNE))
      0083F0                        306 00115$:
      0083F0 AE C3 50         [ 2]  307 	ldw	x, #0xc350
      0083F3                        308 00107$:
      0083F3 72 0C 52 17 0A   [ 2]  309 	btjt	0x5217, #6, 00109$
                                    310 ;	../../my_STM8_libraries/stm8_I2C.c: 123: if (--timeout == 0) 
      0083F8 5A               [ 2]  311 	decw	x
      0083F9 5D               [ 2]  312 	tnzw	x
      0083FA 26 F7            [ 1]  313 	jrne	00107$
                                    314 ;	../../my_STM8_libraries/stm8_I2C.c: 125: stop_I2C();
      0083FC CD 82 EE         [ 4]  315 	call	_stop_I2C
                                    316 ;	../../my_STM8_libraries/stm8_I2C.c: 126: return 0;
      0083FF 4F               [ 1]  317 	clr	a
      008400 20 0F            [ 2]  318 	jra	00110$
      008402                        319 00109$:
                                    320 ;	../../my_STM8_libraries/stm8_I2C.c: 129: *data = I2C_DR;
      008402 C6 52 16         [ 1]  321 	ld	a, 0x5216
      008405 1E 01            [ 2]  322 	ldw	x, (0x01, sp)
      008407 F7               [ 1]  323 	ld	(x), a
                                    324 ;	../../my_STM8_libraries/stm8_I2C.c: 130: stop_I2C();
      008408 CD 82 EE         [ 4]  325 	call	_stop_I2C
                                    326 ;	../../my_STM8_libraries/stm8_I2C.c: 131: I2C_CR2 |= I2C_CR2_ACK;
      00840B 72 14 52 11      [ 1]  327 	bset	0x5211, #2
                                    328 ;	../../my_STM8_libraries/stm8_I2C.c: 132: return 1;
      00840F A6 01            [ 1]  329 	ld	a, #0x01
      008411                        330 00110$:
                                    331 ;	../../my_STM8_libraries/stm8_I2C.c: 133: }
      008411 5B 03            [ 2]  332 	addw	sp, #3
      008413 81               [ 4]  333 	ret
                                    334 	.area CODE
                                    335 	.area CONST
