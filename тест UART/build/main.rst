      ...
      008068 CC 80 98         [ 2]  112 	jp	_main
                                    ...
                                    116 ;--------------------------------------------------------
                                    117 	.area CODE
                                    118 ;	main.c: 7: void TIM4_UPD_OVF_IRQHandler(void) __interrupt(23) {
                                    119 ;	-----------------------------------------
      ...
      008094 CD 84 E5         [ 4]  128 	call	_tick_TIME
                                    129 ;	main.c: 10: }
      008097 80               [11]  130 	iret
                                    131 ;	main.c: 12: void main(void) {
                                    132 ;	-----------------------------------------
                                    133 ;	 function main
                                    134 ;	-----------------------------------------
      008098                        135 _main:
                                    136 ;	main.c: 14: CLK_CKDIVR = 0;		// 1. Устанавливаем частоту 16 МГц
      008098 35 00 50 C6      [ 1]  137 	mov	0x50c6+0, #0x00
                                    138 ;	main.c: 16: init_UART(9600);	// 2. Инициализируем периферию
      00809C AE 25 80         [ 2]  139 	ldw	x, #0x2580
      00809F CD 85 95         [ 4]  140 	call	_init_UART
                                    141 ;	main.c: 17: init_TIME();
      0080A2 CD 84 F9         [ 4]  142 	call	_init_TIME
                                    143 ;	main.c: 19: pinMode(PORTC, 3, OUTPUT);
      0080A5 4B 00            [ 1]  144 	push	#0x00
      0080A7 A6 03            [ 1]  145 	ld	a, #0x03
      0080A9 AE 50 0A         [ 2]  146 	ldw	x, #0x500a
      0080AC CD 81 6C         [ 4]  147 	call	_pinMode
                                    148 ;	main.c: 21: while(1)
      0080AF                        149 00104$:
                                    150 ;	main.c: 23: if (write_UART('A') == 0) 
      0080AF A6 41            [ 1]  151 	ld	a, #0x41
      0080B1 CD 85 CA         [ 4]  152 	call	_write_UART
      0080B4 4D               [ 1]  153 	tnz	a
      0080B5 26 0A            [ 1]  154 	jrne	00102$
                                    155 ;	main.c: 25: writePin(PORTC, 3, HIGH);
      0080B7 4B 01            [ 1]  156 	push	#0x01
      0080B9 A6 03            [ 1]  157 	ld	a, #0x03
      0080BB AE 50 0A         [ 2]  158 	ldw	x, #0x500a
      0080BE CD 81 FA         [ 4]  159 	call	_writePin
      0080C1                        160 00102$:
                                    161 ;	main.c: 27: writePin(PORTC, 3, LOW);
      0080C1 4B 00            [ 1]  162 	push	#0x00
      0080C3 A6 03            [ 1]  163 	ld	a, #0x03
      0080C5 AE 50 0A         [ 2]  164 	ldw	x, #0x500a
      0080C8 CD 81 FA         [ 4]  165 	call	_writePin
                                    166 ;	main.c: 28: delay(1000);  
      0080CB 4B E8            [ 1]  167 	push	#0xe8
      0080CD 4B 03            [ 1]  168 	push	#0x03
      0080CF 5F               [ 1]  169 	clrw	x
      0080D0 89               [ 2]  170 	pushw	x
      0080D1 CD 85 61         [ 4]  171 	call	_delay
      0080D4 20 D9            [ 2]  172 	jra	00104$
                                    173 ;	main.c: 30: }
      0080D6 81               [ 4]  174 	ret
                                    175 	.area CODE
                                    176 	.area CONST
