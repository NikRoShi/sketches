      ...
      0083B0 72 1A 50 C7      [ 1]   61 	bset	0x50c7, #5
                                     62 ;	../../my_STM8_libraries/stm8_PWM.c: 8: memory_period = period;			// запомним период чтобы считать проценты
      0083B4 CF 00 01         [ 2]   63 	ldw	_memory_period+0, x
                                     64 ;	../../my_STM8_libraries/stm8_PWM.c: 10: TIM2_ARRH = (uint8_t)((period >> 8));	//устанавливаем период
      0083B7 9E               [ 1]   65 	ld	a, xh
      0083B8 C7 53 0F         [ 1]   66 	ld	0x530f, a
                                     67 ;	../../my_STM8_libraries/stm8_PWM.c: 11: TIM2_ARRL = (uint8_t)((period & 0xFF));
      0083BB 9F               [ 1]   68 	ld	a, xl
      0083BC C7 53 10         [ 1]   69 	ld	0x5310, a
                                     70 ;	../../my_STM8_libraries/stm8_PWM.c: 13: TIM2_CCMR1 &= ~(0b111 << 4);		//сбрасываем значения настройки в 0 PD4
      0083BF C6 53 07         [ 1]   71 	ld	a, 0x5307
      0083C2 A4 8F            [ 1]   72 	and	a, #0x8f
      0083C4 C7 53 07         [ 1]   73 	ld	0x5307, a
                                     74 ;	../../my_STM8_libraries/stm8_PWM.c: 14: TIM2_CCMR2 &= ~(0b111 << 4);		//PD3
      0083C7 C6 53 08         [ 1]   75 	ld	a, 0x5308
      0083CA A4 8F            [ 1]   76 	and	a, #0x8f
      0083CC C7 53 08         [ 1]   77 	ld	0x5308, a
                                     78 ;	../../my_STM8_libraries/stm8_PWM.c: 15: TIM2_CCMR3 &= ~(0b111 << 4);		//PA3
      0083CF C6 53 09         [ 1]   79 	ld	a, 0x5309
      0083D2 A4 8F            [ 1]   80 	and	a, #0x8f
      0083D4 C7 53 09         [ 1]   81 	ld	0x5309, a
                                     82 ;	../../my_STM8_libraries/stm8_PWM.c: 17: TIM2_CCMR1 |= (0b110 << 4);		//настроить режим работы вывода PD4
      0083D7 C6 53 07         [ 1]   83 	ld	a, 0x5307
      0083DA AA 60            [ 1]   84 	or	a, #0x60
      0083DC C7 53 07         [ 1]   85 	ld	0x5307, a
                                     86 ;	../../my_STM8_libraries/stm8_PWM.c: 18: TIM2_CCMR2 |= (0b110 << 4);		//PD3
      0083DF C6 53 08         [ 1]   87 	ld	a, 0x5308
      0083E2 AA 60            [ 1]   88 	or	a, #0x60
      0083E4 C7 53 08         [ 1]   89 	ld	0x5308, a
                                     90 ;	../../my_STM8_libraries/stm8_PWM.c: 19: TIM2_CCMR3 |= (0b110 << 4);		//PA3
      0083E7 C6 53 09         [ 1]   91 	ld	a, 0x5309
      0083EA AA 60            [ 1]   92 	or	a, #0x60
      0083EC C7 53 09         [ 1]   93 	ld	0x5309, a
                                     94 ;	../../my_STM8_libraries/stm8_PWM.c: 21: TIM2_CCMR1 |= (1 << 3);		//настроить PD4 как выход
      0083EF 72 16 53 07      [ 1]   95 	bset	0x5307, #3
                                     96 ;	../../my_STM8_libraries/stm8_PWM.c: 22: TIM2_CCMR2 |= (1 << 3);		//PD3
      0083F3 72 16 53 08      [ 1]   97 	bset	0x5308, #3
                                     98 ;	../../my_STM8_libraries/stm8_PWM.c: 23: TIM2_CCMR3 |= (1 << 3);		//PA3
      0083F7 72 16 53 09      [ 1]   99 	bset	0x5309, #3
                                    100 ;	../../my_STM8_libraries/stm8_PWM.c: 25: TIM2_CCMR1 &= ~0b11;		//настроить PD4 как выход
      0083FB C6 53 07         [ 1]  101 	ld	a, 0x5307
      0083FE A4 FC            [ 1]  102 	and	a, #0xfc
      008400 C7 53 07         [ 1]  103 	ld	0x5307, a
                                    104 ;	../../my_STM8_libraries/stm8_PWM.c: 26: TIM2_CCMR2 &= ~0b11;		//PD3
      008403 C6 53 08         [ 1]  105 	ld	a, 0x5308
      008406 A4 FC            [ 1]  106 	and	a, #0xfc
      008408 C7 53 08         [ 1]  107 	ld	0x5308, a
                                    108 ;	../../my_STM8_libraries/stm8_PWM.c: 27: TIM2_CCMR3 &= ~0b11;		//PA3
      00840B C6 53 09         [ 1]  109 	ld	a, 0x5309
      00840E A4 FC            [ 1]  110 	and	a, #0xfc
      008410 C7 53 09         [ 1]  111 	ld	0x5309, a
                                    112 ;	../../my_STM8_libraries/stm8_PWM.c: 29: TIM2_CR1 |= (1 << 7) | (1 << 0);
      008413 C6 53 00         [ 1]  113 	ld	a, 0x5300
      008416 AA 81            [ 1]  114 	or	a, #0x81
      008418 C7 53 00         [ 1]  115 	ld	0x5300, a
      ...
      00841B 81               [ 4]  117 	ret
                                    ...
                                    121 ;	-----------------------------------------
      00841C                        122 _startChannel_PWM:
                                    123 ;	../../my_STM8_libraries/stm8_PWM.c: 33: switch (channel) {
      00841C A1 01            [ 1]  124 	cp	a, #0x01
      00841E 27 09            [ 1]  125 	jreq	00101$
      008420 A1 02            [ 1]  126 	cp	a, #0x02
      008422 27 12            [ 1]  127 	jreq	00102$
      008424 A1 03            [ 1]  128 	cp	a, #0x03
      008426 27 1B            [ 1]  129 	jreq	00103$
      008428 81               [ 4]  130 	ret
                                    131 ;	../../my_STM8_libraries/stm8_PWM.c: 34: case 1:		//PD4
      008429                        132 00101$:
                                    133 ;	../../my_STM8_libraries/stm8_PWM.c: 35: PD_DDR |= (1 << 4);
      008429 72 18 50 11      [ 1]  134 	bset	0x5011, #4
                                    135 ;	../../my_STM8_libraries/stm8_PWM.c: 36: PD_CR1 |= (1 << 4);
      00842D 72 18 50 12      [ 1]  136 	bset	0x5012, #4
                                    137 ;	../../my_STM8_libraries/stm8_PWM.c: 37: TIM2_CCER1 |= (1 << 0);	
      008431 72 10 53 0A      [ 1]  138 	bset	0x530a, #0
      ...
      008436 72 16 50 11      [ 1]  144 	bset	0x5011, #3
                                    145 ;	../../my_STM8_libraries/stm8_PWM.c: 41: PD_CR1 |= (1 << 3);
      00843A 72 16 50 12      [ 1]  146 	bset	0x5012, #3
                                    147 ;	../../my_STM8_libraries/stm8_PWM.c: 42: TIM2_CCER1 |= (1 << 4);	
      00843E 72 18 53 0A      [ 1]  148 	bset	0x530a, #4
      ...
      008443 72 16 50 02      [ 1]  154 	bset	0x5002, #3
                                    155 ;	../../my_STM8_libraries/stm8_PWM.c: 46: PA_CR1 |= (1 << 3);
      008447 72 16 50 03      [ 1]  156 	bset	0x5003, #3
                                    157 ;	../../my_STM8_libraries/stm8_PWM.c: 47: TIM2_CCER2 |= (1 << 0);	
      00844B 72 10 53 0B      [ 1]  158 	bset	0x530b, #0
      ...
      00844F 81               [ 4]  161 	ret
                                    ...
                                    165 ;	-----------------------------------------
      008450                        166 _stopChannel_PWM:
                                    167 ;	../../my_STM8_libraries/stm8_PWM.c: 54: switch (channel) {
      008450 A1 01            [ 1]  168 	cp	a, #0x01
      008452 27 09            [ 1]  169 	jreq	00101$
      008454 A1 02            [ 1]  170 	cp	a, #0x02
      008456 27 0A            [ 1]  171 	jreq	00102$
      008458 A1 03            [ 1]  172 	cp	a, #0x03
      00845A 27 0B            [ 1]  173 	jreq	00103$
      00845C 81               [ 4]  174 	ret
                                    175 ;	../../my_STM8_libraries/stm8_PWM.c: 55: case 1:		//PD4
      00845D                        176 00101$:
                                    177 ;	../../my_STM8_libraries/stm8_PWM.c: 56: TIM2_CCER1 &= ~(1 << 0);
      00845D 72 11 53 0A      [ 1]  178 	bres	0x530a, #0
      ...
      008462 72 19 53 0A      [ 1]  184 	bres	0x530a, #4
      ...
      008467 72 11 53 0B      [ 1]  190 	bres	0x530b, #0
      ...
      00846B 81               [ 4]  193 	ret
                                    ...
                                    197 ;	-----------------------------------------
      00846C                        198 _write_PWM:
                                    199 ;	../../my_STM8_libraries/stm8_PWM.c: 72: TIM2_CCR1L = (uint8_t)(value & 0xFF);
      00846C 90 93            [ 1]  200 	ldw	y, x
                                    201 ;	../../my_STM8_libraries/stm8_PWM.c: 69: switch (channel) {
      00846E A1 01            [ 1]  202 	cp	a, #0x01
      008470 27 09            [ 1]  203 	jreq	00101$
      008472 A1 02            [ 1]  204 	cp	a, #0x02
      008474 27 10            [ 1]  205 	jreq	00102$
      008476 A1 03            [ 1]  206 	cp	a, #0x03
      008478 27 17            [ 1]  207 	jreq	00103$
      00847A 81               [ 4]  208 	ret
                                    209 ;	../../my_STM8_libraries/stm8_PWM.c: 70: case 1:
      00847B                        210 00101$:
                                    211 ;	../../my_STM8_libraries/stm8_PWM.c: 71: TIM2_CCR1H = (uint8_t)(value >> 8);
      00847B 9E               [ 1]  212 	ld	a, xh
      00847C C7 53 11         [ 1]  213 	ld	0x5311, a
                                    214 ;	../../my_STM8_libraries/stm8_PWM.c: 72: TIM2_CCR1L = (uint8_t)(value & 0xFF);
      00847F AE 53 12         [ 2]  215 	ldw	x, #0x5312
      008482 90 9F            [ 1]  216 	ld	a, yl
      008484 F7               [ 1]  217 	ld	(x), a
      ...
      008486 9E               [ 1]  223 	ld	a, xh
      008487 C7 53 13         [ 1]  224 	ld	0x5313, a
                                    225 ;	../../my_STM8_libraries/stm8_PWM.c: 76: TIM2_CCR2L = (uint8_t)(value & 0xFF);
      00848A AE 53 14         [ 2]  226 	ldw	x, #0x5314
      00848D 90 9F            [ 1]  227 	ld	a, yl
      00848F F7               [ 1]  228 	ld	(x), a
      ...
      008491 9E               [ 1]  234 	ld	a, xh
      008492 C7 53 15         [ 1]  235 	ld	0x5315, a
                                    236 ;	../../my_STM8_libraries/stm8_PWM.c: 80: TIM2_CCR3L = (uint8_t)(value & 0xFF);
      008495 AE 53 16         [ 2]  237 	ldw	x, #0x5316
      008498 90 9F            [ 1]  238 	ld	a, yl
      00849A F7               [ 1]  239 	ld	(x), a
      ...
      00849B 81               [ 4]  242 	ret
                                    ...
                                    246 ;	-----------------------------------------
      00849C                        247 _writePercent_PWM:
      00849C 52 09            [ 2]  248 	sub	sp, #9
      00849E 6B 09            [ 1]  249 	ld	(0x09, sp), a
                                    250 ;	../../my_STM8_libraries/stm8_PWM.c: 87: if (percent > 100) percent = 100;
      0084A0 7B 0C            [ 1]  251 	ld	a, (0x0c, sp)
      0084A2 A1 64            [ 1]  252 	cp	a, #0x64
      0084A4 23 04            [ 2]  253 	jrule	00102$
      0084A6 A6 64            [ 1]  254 	ld	a, #0x64
      0084A8 6B 0C            [ 1]  255 	ld	(0x0c, sp), a
      0084AA                        256 00102$:
                                    257 ;	../../my_STM8_libraries/stm8_PWM.c: 88: uint16_t value = (uint16_t)(((uint32_t)percent * memory_period) / 100);
      0084AA 7B 0C            [ 1]  258 	ld	a, (0x0c, sp)
      0084AC 5F               [ 1]  259 	clrw	x
      0084AD 1F 01            [ 2]  260 	ldw	(0x01, sp), x
      0084AF 90 CE 00 01      [ 2]  261 	ldw	y, _memory_period+0
      0084B3 0F 06            [ 1]  262 	clr	(0x06, sp)
      0084B5 0F 05            [ 1]  263 	clr	(0x05, sp)
      0084B7 90 89            [ 2]  264 	pushw	y
      0084B9 16 07            [ 2]  265 	ldw	y, (0x07, sp)
      0084BB 90 89            [ 2]  266 	pushw	y
      0084BD 88               [ 1]  267 	push	a
      0084BE 9E               [ 1]  268 	ld	a, xh
      0084BF 88               [ 1]  269 	push	a
      0084C0 1E 07            [ 2]  270 	ldw	x, (0x07, sp)
      0084C2 89               [ 2]  271 	pushw	x
      0084C3 CD 86 36         [ 4]  272 	call	__mullong
      0084C6 5B 08            [ 2]  273 	addw	sp, #8
      0084C8 4B 64            [ 1]  274 	push	#0x64
      0084CA 4B 00            [ 1]  275 	push	#0x00
      0084CC 4B 00            [ 1]  276 	push	#0x00
      0084CE 4B 00            [ 1]  277 	push	#0x00
      0084D0 89               [ 2]  278 	pushw	x
      0084D1 90 89            [ 2]  279 	pushw	y
      0084D3 CD 85 DD         [ 4]  280 	call	__divulong
      0084D6 5B 08            [ 2]  281 	addw	sp, #8
                                    282 ;	../../my_STM8_libraries/stm8_PWM.c: 89: write_PWM(channel, value);
      0084D8 7B 09            [ 1]  283 	ld	a, (0x09, sp)
      0084DA 16 0A            [ 2]  284 	ldw	y, (10, sp)
      0084DC 17 0B            [ 2]  285 	ldw	(11, sp), y
      0084DE 5B 0A            [ 2]  286 	addw	sp, #10
                                    287 ;	../../my_STM8_libraries/stm8_PWM.c: 90: }
      0084E0 CC 84 6C         [ 2]  288 	jp	_write_PWM
      0084E3 84               [ 1]  289 	pop	a
      0084E4 FC               [ 2]  290 	jp	(x)
                                    291 	.area CODE
                                    292 	.area CONST
