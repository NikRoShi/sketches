...
;	../../my_STM8_libraries/stm8_UART.c: 69: }
	ret
;	../../my_STM8_libraries/stm8_UART.c: 71: void sendHex_UART(uint8_t num)
;	-----------------------------------------
...
;	../../my_STM8_libraries/stm8_UART.c: 76: if (high < 10) sendByte_UART(high + '0');
	...
	call	_sendByte_UART
00102$:
;	../../my_STM8_libraries/stm8_UART.c: 77: if (low >= 10) sendByte_UART(high - 10 + 'A');
	ld	a, (0x03, sp)
	cp	a, #0x0a
	clr	a
	rlc	a
...
;	../../my_STM8_libraries/stm8_UART.c: 79: if (low < 10) sendByte_UART(low + '0');
	...
	call	_sendByte_UART
00106$:
;	../../my_STM8_libraries/stm8_UART.c: 80: if (low >= 10) sendByte_UART(low - 10 + 'A');
	tnz	(0x02, sp)
	jrne	00109$
	ld	a, (0x03, sp)
	add	a, #0x37
