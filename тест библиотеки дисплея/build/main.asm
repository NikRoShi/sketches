...
;	main.c: 18: enableInterrupts();
	rim
;	main.c: 22: for (uint8_t position = 0; position < 8; position++)
00117$:
	clr	(0x01, sp)
00110$:
	ld	a, (0x01, sp)
	cp	a, #0x08
	jrnc	00102$
;	main.c: 24: for (uint8_t digit = 0; digit < 10; digit++)
	clr	(0x02, sp)
00107$:
	ld	a, (0x02, sp)
	cp	a, #0x0a
	jrnc	00111$
;	main.c: 26: setDigit(position, digit);
	ld	a, (0x02, sp)
	push	a
	ld	a, (0x02, sp)
	call	_setDigit
