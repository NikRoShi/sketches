...
;	../../my_STM8_libraries/stm8_I2C.c: 199: clearADDR_I2C();
	call	_clearADDR_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 201: while (!(I2C_SR1 & I2C_SR1_RXNE))
	ldw	x, #0xc350
00113$:
	btjt	0x5217, #6, 00115$
;	../../my_STM8_libraries/stm8_I2C.c: 203: if (--timeout == 0)
	decw	x
	ldw	(0x01, sp), x
	tnzw	x
	jrne	00113$
;	../../my_STM8_libraries/stm8_I2C.c: 205: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 206: return 0;
	clr	a
	jra	00121$
00115$:
;	../../my_STM8_libraries/stm8_I2C.c: 209: buf[0] = I2C_DR;
	ldw	y, (0x09, sp)
	ldw	(0x03, sp), y
	ld	a, 0x5216
	ldw	x, (0x03, sp)
	ld	(x), a
;	../../my_STM8_libraries/stm8_I2C.c: 210: setACK_I2C(LOW);
	clr	a
	call	_setACK_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 212: while (!(I2C_SR1 & I2C_SR1_BTF))
	ldw	x, (0x01, sp)
00118$:
	btjt	0x5217, #2, 00120$
;	../../my_STM8_libraries/stm8_I2C.c: 214: if (--timeout == 0)
	decw	x
	tnzw	x
	jrne	00118$
;	../../my_STM8_libraries/stm8_I2C.c: 216: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 217: return 0;
	clr	a
	jra	00121$
00120$:
;	../../my_STM8_libraries/stm8_I2C.c: 220: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 222: buf[1] = I2C_DR;
	ldw	x, (0x03, sp)
	incw	x
	ld	a, 0x5216
	ld	(x), a
;	../../my_STM8_libraries/stm8_I2C.c: 224: setACK_I2C(HIGH);
	ld	a, #0x01
	call	_setACK_I2C
...
;	../../my_STM8_libraries/stm8_I2C.c: 231: uint8_t i = 0;
	clr	(0x03, sp)
;	../../my_STM8_libraries/stm8_I2C.c: 233: if (size == 1) 
	ld	a, (0x0c, sp)
	dec	a
	jrne	00104$
;	../../my_STM8_libraries/stm8_I2C.c: 235: if (readReg_I2C(address, reg, buf) == 0) return 0;
	ldw	x, (0x0a, sp)
	pushw	x
	ld	a, (0x0b, sp)
	push	a
	...
	jp	00137$
00102$:
;	../../my_STM8_libraries/stm8_I2C.c: 236: return 1;
	ld	a, #0x01
	jp	00137$
00104$:
;	../../my_STM8_libraries/stm8_I2C.c: 238: if (size == 2)
	ld	a, (0x0c, sp)
	cp	a, #0x02
	jrne	00108$
;	../../my_STM8_libraries/stm8_I2C.c: 240: if (readBuffer2_I2C(address, reg, buf) == 0) return 0;
	ldw	x, (0x0a, sp)
	pushw	x
	ld	a, (0x0b, sp)
	push	a
	...
	jp	00137$
00106$:
;	../../my_STM8_libraries/stm8_I2C.c: 241: return 1;
	ld	a, #0x01
	jp	00137$
00108$:
;	../../my_STM8_libraries/stm8_I2C.c: 243: if (start_I2C() == 0) return 0;
	call	_start_I2C
	tnz	a
	jrne	00110$
	clr	a
	jp	00137$
00110$:
;	../../my_STM8_libraries/stm8_I2C.c: 245: if (writeAddr_I2C(address, WRITE) == 0) return 0;
	push	#0x00
	ld	a, (0x05, sp)
	call	_writeAddr_I2C
	tnz	a
	...
	jp	00137$
00112$:
;	../../my_STM8_libraries/stm8_I2C.c: 246: clearADDR_I2C();
	call	_clearADDR_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 248: if (writeByte_I2C(reg) == 0) return 0;
	ld	a, (0x09, sp)
	call	_writeByte_I2C
	tnz	a
	jrne	00114$
	...
	jp	00137$
00114$:
;	../../my_STM8_libraries/stm8_I2C.c: 250: if (start_I2C() == 0) return 0;
	call	_start_I2C
	tnz	a
	jrne	00116$
	clr	a
	jp	00137$
00116$:
;	../../my_STM8_libraries/stm8_I2C.c: 252: if (writeAddr_I2C(address, READ) == 0) return 0;
	push	#0x01
	ld	a, (0x05, sp)
	call	_writeAddr_I2C
	tnz	a
	...
	jp	00137$
00118$:
;	../../my_STM8_libraries/stm8_I2C.c: 253: clearADDR_I2C();
	call	_clearADDR_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 255: while (size > 3)
	clr	(0x05, sp)
	ld	a, (0x0c, sp)
	ld	(0x06, sp), a
00124$:
	...
	cp	a, #0x03
	jrule	00153$
;	../../my_STM8_libraries/stm8_I2C.c: 257: while (!(I2C_SR1 & I2C_SR1_RXNE))
	ldw	x, (0x01, sp)
00121$:
	btjt	0x5217, #6, 00123$
;	../../my_STM8_libraries/stm8_I2C.c: 259: if (--timeout == 0)
	decw	x
	tnzw	x
	jrne	00121$
;	../../my_STM8_libraries/stm8_I2C.c: 261: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 262: return 0;
	clr	a
	jra	00137$
00123$:
;	../../my_STM8_libraries/stm8_I2C.c: 265: timeout = 50000;
	ldw	x, #0xc350
	ldw	(0x01, sp), x
;	../../my_STM8_libraries/stm8_I2C.c: 266: buf[i] = I2C_DR;
	clrw	x
	ld	a, (0x05, sp)
	ld	xl, a
	addw	x, (0x0a, sp)
	ld	a, 0x5216
	ld	(x), a
;	../../my_STM8_libraries/stm8_I2C.c: 267: i++;
	inc	(0x05, sp)
	ld	a, (0x05, sp)
	ld	(0x03, sp), a
;	../../my_STM8_libraries/stm8_I2C.c: 268: size--;
	dec	(0x06, sp)
	jra	00124$
;	../../my_STM8_libraries/stm8_I2C.c: 271: while (!(I2C_SR1 & I2C_SR1_BTF))
00153$:
	ldw	x, (0x01, sp)
00129$:
	btjt	0x5217, #2, 00131$
;	../../my_STM8_libraries/stm8_I2C.c: 273: if (--timeout == 0)
	decw	x
	tnzw	x
	jrne	00129$
;	../../my_STM8_libraries/stm8_I2C.c: 275: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 276: return 0;
	clr	a
	jra	00137$
00131$:
;	../../my_STM8_libraries/stm8_I2C.c: 281: setACK_I2C(LOW);
	clr	a
	call	_setACK_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 283: buf[i] = I2C_DR;
	clrw	x
	ld	a, (0x03, sp)
	ld	xl, a
	addw	x, (0x0a, sp)
	ld	a, 0x5216
	ld	(x), a
;	../../my_STM8_libraries/stm8_I2C.c: 284: i++;
	ld	a, (0x03, sp)
	inc	a
	ld	(0x06, sp), a
;	../../my_STM8_libraries/stm8_I2C.c: 286: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 288: buf[i] = I2C_DR;
	clrw	x
	ld	a, (0x06, sp)
	ld	xl, a
	addw	x, (0x0a, sp)
	ld	a, 0x5216
	ld	(x), a
;	../../my_STM8_libraries/stm8_I2C.c: 289: i++;
	inc	(0x06, sp)
;	../../my_STM8_libraries/stm8_I2C.c: 291: while (!(I2C_SR1 & I2C_SR1_RXNE))
	ldw	x, #0xc350
00134$:
	btjt	0x5217, #6, 00136$
;	../../my_STM8_libraries/stm8_I2C.c: 293: if (--timeout == 0)
	decw	x
	tnzw	x
	jrne	00134$
;	../../my_STM8_libraries/stm8_I2C.c: 295: stop_I2C();
	call	_stop_I2C
;	../../my_STM8_libraries/stm8_I2C.c: 296: return 0;
	clr	a
	jra	00137$
00136$:
;	../../my_STM8_libraries/stm8_I2C.c: 299: buf[i] = I2C_DR;
	clrw	x
	ld	a, (0x06, sp)
	ld	xl, a
	addw	x, (0x0a, sp)
	ld	a, 0x5216
	ld	(x), a
;	../../my_STM8_libraries/stm8_I2C.c: 301: setACK_I2C(HIGH);
	ld	a, #0x01
	call	_setACK_I2C
